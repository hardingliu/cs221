...
void printTree(Node *r) { printTreeHelper(r, 0); }
// *******************************************
...
int traversalValues[] = {
    70, 0, 0, 70, 1, 0, 10, 0, 1, 70, 0, 1, 60, 1, 0, 10, 0, 1, 70, 0, 1,
    60, 2, 0, 20, 0, 2, 10, 1, 1, 70, 0, 1, 60, 2, 0, 50, 0, 2, 20, 1, 1,
    10, 0, 2, 70, 0, 2, 60, 1, 1, 50, 2, 0, 30, 0, 2, 20, 1, 1, 10, 0, 2,
    70, 0, 2, 60, 1, 1, 50, 3, 0, 40, 0, 3, 30, 1, 2, 20, 2, 1, 10, 0, 2,
    70, 0, 2, 60, 1, 1, 50, 3, 0, 40, 0, 3, 30, 1, 2, 25, 0, 3, 20, 2, 1,
    10, 0, 2, 70, 0, 2, 60, 1, 1, 50, 3, 0, 40, 0, 3, 30, 1, 2, 27, 0, 3,
    25, 2, 1, 20, 1, 2, 10, 0, 3, 70, 0, 2, 60, 1, 1, 50, 3, 0, 40, 0, 3,
    30, 1, 2, 27, 0, 3, 25, 2, 1, 20, 0, 3, 10, 1, 2, 5,  0, 3};
